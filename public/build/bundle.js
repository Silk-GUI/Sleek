...
/***/ function(module, exports, __webpack_require__) {
	...
	var _load = __webpack_require__(28);
	
	var _load2 = _interopRequireDefault(_load);
	
	var _desktop = __webpack_require__(30);
	
	var _desktop2 = _interopRequireDefault(_desktop);
	
	var _window_manager_ = __webpack_require__(20);
	
	var _window_manager_2 = _interopRequireDefault(_window_manager_);
	  ...
	  created: function created() {
	    ...
	    try {
	      _load2.default.load(function (err, data) {
	        ...
	        _window_manager_2.default.updateAppData(data);
	      });
	    } catch (e) {
	      console.log(e);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      windows: _window_manager_2.default.windows
	    };
	  },
	
	  methods: {
	    open: function open(index) {
	      _window_manager_2.default.maximizeWindow(index);
	    },
	    menu: function menu() {
	    ...
	    close: function close(index) {
	      _window_manager_2.default.closeWindow(index);
	    }
	  }
	};
...
/***/ function(module, exports) {
	...
	WindowManager.prototype.reorder = function (index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WindowManager = __webpack_require__(20);
	exports.default = {
	  data: function data() {
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var remote = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    buildChannel: function buildChannel() {
	      console.log("build channel");
	    },
	    minimize: function minimize(index) {
	      _window_manager_2.default.minimizeWindow(index);
	    },
	    close: function close(index) {
	      _window_manager_2.default.closeWindow(index);
	    }
